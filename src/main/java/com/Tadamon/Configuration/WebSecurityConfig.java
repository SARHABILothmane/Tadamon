package com.Tadamon.Configuration;
...
//			    .authorizeRequests().antMatchers("/api/admins").permitAll()
			    ...
			    .antMatchers("/api/volunteers").hasAuthority("volunteer")
			    .antMatchers("/api/treasurers").hasAuthority("treasurer")
			    .antMatchers("/api/receivers").hasAuthority("receiver")
